package br.com.gohlsolucoes.controls.gcustomtabbar {
	...
	import br.com.gohlsolucoes.controls.gcustomtabbar.events.CustomTabBarReorderEvent;
	import br.com.gohlsolucoes.controls.gcustomtabbar.layouts.CustomTabBarHorizontalLayout;
	import br.com.gohlsolucoes.controls.gcustomtabbar.skins.CustomTabBarSkin;
	...
	[Event(name='tabReordered',type='br.com.gohlsolucoes.controls.gcustomtabbar.events.CustomTabBarReorderEvent')]
	
	public class GCustomTabBar extends TabBar {
		...
		public function GCustomTabBar() {
			super();
			this.setStyle('skinClass', br.com.gohlsolucoes.controls.gcustomtabbar.skins.CustomTabBarSkin);
			this.setStyle('dragIndicatorClass', br.com.gohlsolucoes.controls.gcustomtabbar.CustomButtonBarButtonDragProxy);
			this.setStyle('dropIndicatorSkin', br.com.gohlsolucoes.controls.gcustomtabbar.CustomTabBarDropIndicator);
			//this.dragIndicatorClass = "br.com.gohlsolucoes.controls.gcustomtabbar.CustomButtonBarButtonDragProxy";
		}
		...
		[Inspectable(arrayType="Boolean", category="Common", defaultValue="false")]
		...
		private function dataGroup_rendererAddHandler2(event:RendererExistenceEvent):void {
		...
		private function dataGroup_rendererRemoveHandler2(event:RendererExistenceEvent):void {
			var index:int = event.index;
		...
		protected override function partAdded(partName:String, instance:Object):void {
			...
			if(instance == dataGroup){
				dataGroup.addEventListener(RendererExistenceEvent.RENDERER_ADD, dataGroup_rendererAddHandler2);
				dataGroup.addEventListener(RendererExistenceEvent.RENDERER_REMOVE, dataGroup_rendererRemoveHandler2);
		...
		protected override function partRemoved(partName:String, instance:Object):void {
			...
			if(instance == dataGroup){
				dataGroup.removeEventListener(RendererExistenceEvent.RENDERER_ADD, dataGroup_rendererAddHandler2);
				dataGroup.removeEventListener(RendererExistenceEvent.RENDERER_REMOVE, dataGroup_rendererRemoveHandler2);
